...
import { FlatList, ListViewProps, ListRenderItemInfo, NativeSyntheticEvent, NativeScrollEvent, StyleProp, ViewStyle, ViewToken } from 'react-native';
...
export default class MessageContainer<TMessage extends IMessage = IMessage> extends React.PureComponent<MessageContainerProps<TMessage>, State> {
    ...
    static propTypes: {
        ...
        lastReadDetails: PropTypes.Requireable<object>;
        resetLastReadDetails: PropTypes.Requireable<(...args: any[]) => any>;
    };
    state: {
        showScrollBottom: boolean;
        showScrollToIndexButton: boolean;
